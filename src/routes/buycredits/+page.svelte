...
<main class="w-[100vw] flex flex-row font-sans">
    <section
        class="md:w-[50vw] hidden h-[100vh] p-24 bg-[rgb(254,241,24, 0.5)] md:flex flex-col justify-center"
    ...
    >
        ...
        <div >
            ...
            <p class="pt-4 text-lg">
                Grab extra credits to continue listening with Readel. Get
            ...
            <div class=" mt-10 bg-[rgba(255, 251, 40, 1)] p-10 border border-neutral-700 rounded-lg shadow-lg">
                ...
                <p>
                    When you buy more characters, they will instantly be added
                    to your Readel account.
                </p>
                <p class="mt-2">
                    The characters will be added to the daily limit. For
                    example, if the default daily limit is 10,000 characters and
                    you buy 30,000 characters, your new daily limit is 40,000
                    characters.
                </p>
                <p class="mt-2">
                    Please <a
                ...
                <h2 class="font-bold text-lg mt-4">Do you handle payments?</h2>
                <p>
                    No. A company called <a
                        href="https://www.stripe.com"
                        target="_blank"
                        class="underline">Stripe</a
                    > handles all payments and credit/debit card details. I don't
                    see any of your credit/debit card details.
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="items-start md:w-[40vw]">
            {#if !email_entered}
                <div>
                    ...
                    <p class="text-gray-500 text-md">
                        Please provide the email that is linked to your Readel
                        account.
                    </p>
                    <input
                        class="md:w-[90%] w-[90vw] h-14 mt-5 mb-2 rounded-lg border flex flex-row items-center px-4 {emailFound
                    ...
                    <div class="h-8">
                        {#if emailFound === true}
                            <p class="text-green-600 md:text-md text-sm">
                                Provided email is linked to an Readel account.
                                You can continue.
                            </p>
            ...
            {:else}
                <div>
                    <h2 class="text-2xl leading-none tracking-tight">
                        Selected amount of characters you get <strong
                            >daily</strong
                        >:
                    </h2>
                    <p class="mt-4">
                        Characters will be <strong>added</strong> to your current
                        daily total. For example, If your current daily limit is
                        10,000 characters, and you purchase 30,000 now. You will
                        have 40,000 credits to use daily.
                    </p>
            ...
            <p class="py-10 text-gray-500 text-sm">
                All payments are handled by <a
                    href="https://www.stripe.com"
                    class="underline">Stripe</a
                >. I do not handle payments or hold the personal information of
                users.
            </p>
        </div>
    </section>
